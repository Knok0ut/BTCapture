# Form implementation generated from reading ui file 'ui/DHTWindow.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 248, 729))
        ...
        self.ipport = QtWidgets.QTableWidget(self.scrollAreaWidgetContents)
        self.ipport.setObjectName("ipport")
        self.ipport.setColumnCount(2)
        self.ipport.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.ipport.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.ipport.setHorizontalHeaderItem(1, item)
        self.ipport.horizontalHeader().setVisible(True)
        self.ipport.horizontalHeader().setCascadingSectionResizes(False)
        self.ipport.horizontalHeader().setDefaultSectionSize(125)
        self.ipport.horizontalHeader().setSortIndicatorShown(True)
        self.ipport.horizontalHeader().setStretchLastSection(True)
        self.gridLayout.addWidget(self.ipport, 1, 0, 1, 1)
        ...
        self.nodes = QtWidgets.QTableWidget(self.scrollAreaWidgetContents_2)
        self.nodes.setObjectName("nodes")
        self.nodes.setColumnCount(3)
        ...
        self.nodes.horizontalHeader().setSortIndicatorShown(True)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 249, 729))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "requested_ipport"))
        item = self.ipport.horizontalHeaderItem(0)
        item.setText(_translate("Form", "ipport"))
        item = self.ipport.horizontalHeaderItem(1)
        item.setText(_translate("Form", "num"))
        self.label_2.setText(_translate("Form", "nodes"))
