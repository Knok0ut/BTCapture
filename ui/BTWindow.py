# Form implementation generated from reading ui file 'ui/BTWindow.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.remote_ipport = QtWidgets.QTableWidget(self.scrollAreaWidgetContents_2)
        self.remote_ipport.setObjectName("remote_ipport")
        self.remote_ipport.setColumnCount(2)
        self.remote_ipport.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.remote_ipport.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.remote_ipport.setHorizontalHeaderItem(1, item)
        self.remote_ipport.horizontalHeader().setSortIndicatorShown(True)
        self.remote_ipport.horizontalHeader().setStretchLastSection(True)
        self.verticalLayout.addWidget(self.remote_ipport)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 247, 729))
        ...
        self.type_num.setColumnCount(3)
        ...
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.type_num.setHorizontalHeaderItem(2, item)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 248, 729))
        ...
        self.up_down = QtWidgets.QTableWidget(self.scrollAreaWidgetContents_3)
        self.up_down.setObjectName("up_down")
        self.up_down.setColumnCount(2)
        self.up_down.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.up_down.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.up_down.setHorizontalHeaderItem(1, item)
        self.up_down.horizontalHeader().setSortIndicatorShown(True)
        self.up_down.horizontalHeader().setStretchLastSection(True)
        self.verticalLayout_2.addWidget(self.up_down)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "remote_ipport"))
        item = self.remote_ipport.horizontalHeaderItem(0)
        item.setText(_translate("Form", "ipport"))
        item = self.remote_ipport.horizontalHeaderItem(1)
        item.setText(_translate("Form", "num"))
        ...
        item.setText(_translate("Form", "type"))
        item = self.type_num.horizontalHeaderItem(2)
        item.setText(_translate("Form", "num"))
        self.label_3.setText(_translate("Form", "up_down"))
        item = self.up_down.horizontalHeaderItem(0)
        item.setText(_translate("Form", "type"))
        item = self.up_down.horizontalHeaderItem(1)
        item.setText(_translate("Form", "num"))
